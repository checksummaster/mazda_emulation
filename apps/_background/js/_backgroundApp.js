/*
 ...
 Filename: _backgroundApp.js
 __________________________________________________________________________
 */

log.addSrcFile("_backgroundApp.js", "_background");

function _backgroundApp(uiaId)
{
 ...
 */
_backgroundApp.prototype.appInit = function()
{
    log.debug("_backgroundApp appInit  called...");
 ...
 * =========================
 */
_backgroundApp.prototype._StartContextReady = function ()
{
 ...
 * =========================
 */
framework.registerAppLoaded("_background", null, false);
